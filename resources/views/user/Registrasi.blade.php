            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <x-text-input id="agama" class="block mt-1 w-full" type="text" name="agama" :value="old('agama')" required autofocus autocomplete="off"/>
                    ...
                    <div>
                        ...
                        <x-text-input id="jenis_kelamin" class="block mt-1 w-full" type="number" name="jenis_kelamin" :value="old('jenis_kelamin')" required autofocus autocomplete="off"/>
